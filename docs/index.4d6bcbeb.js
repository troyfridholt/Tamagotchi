...
var _myTamagotchiJs = require("./modules/myTamagotchi.js");
let tama = new _myTamagotchiJs.Tamagotchi();
const img = document.querySelector('img');
const happy = new URL(require("1e24346eac3c184e"));
const angry = new URL(require("b2d574a00391d322"));
const dead = new URL(require("a29956ec87352ba7"));
let intervalID = 0;
img.src = happy.href;
...
function update() {
    ...
    if (cstate === "ARG") img.src = angry.href;
    if (cstate === "GLAD") img.src = happy.href;
...
},{"./modules/myTamagotchi.js":"db4ot","1e24346eac3c184e":"aqj9O","b2d574a00391d322":"hB1HJ","a29956ec87352ba7":"6nojK"}],"db4ot":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Tamagotchi", ()=>Tamagotchi
);
class Tamagotchi {
    #timeup = 5;
    #timedown = 5;
...
},{}],"aqj9O":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('gnRNX') + "happy.8948f74f.jpg" + "?" + Date.now();
...
},{}],"hB1HJ":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('gnRNX') + "angry.39570036.jpg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"6nojK":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('gnRNX') + "dead.09274ebc.jpg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["aOoxC","gLLPy"], "gLLPy", "parcelRequire25c0")
